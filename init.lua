...
require('lazy').setup({
  ...
  { 'farmergreg/vim-lastplace', config = function() end },
...
vim.keymap.set("n", "<leader>ss", vim.cmd.ClangdSwitchSourceHeader)
...
vim.keymap.set("n", "<leader>c", vim.cmd.TSContextToggle)

-- close all buffers except current one
-- <leader>bd :%bd\|e#\|bd#<cr>\|'"
